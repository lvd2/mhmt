...
loc_6069:
                ...
                RLA 
                JR      C,loc_6069
                JR      Z,loc_6078 ;Z important from 'CP 2' above with any Z, from 60CF with NZ
                INC     A
                ADD     A,D
                JR      NC,loc_607F
                SUB     D
...
loc_60DB:
                SBC     A,A ;C preserved, Z <- ~C
                LD      A,#EF

loc_60DE: ; here we can come with Z, NC from above or from loop with C or without jump with Z==~C
...
;		ld	b,8
                ...
                JR      C,loc_60DE
                EXX 
                JR      NZ,loc_60A9 ;Z is used only here
                BIT     7,A
                JR      Z,loc_60CF
                SUB     #EA
                EX      DE,HL
